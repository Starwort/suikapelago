...
def create_and_connect_regions(world: SuikapelagoWorld) -> None:
    create_all_regions(world)
    connect_regions(world)


def create_all_regions(world: SuikapelagoWorld) -> None:
...
def connect_regions(world: SuikapelagoWorld) -> None:
