...
def create_regular_locations(world: SuikapelagoWorld) -> None:
    ...
    bottom_left_chest = SuikapelagoLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, SuikapelagoLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, SuikapelagoLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, SuikapelagoLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, SuikapelagoLocation)
    else:
        overworld.add_locations(top_middle_room_locations, SuikapelagoLocation)
    ...
    if world.options.extra_starting_chest:
        ...
        overworld.add_locations(bottom_left_extra_chest, SuikapelagoLocation)
...
def create_events(world: SuikapelagoWorld) -> None:
    ...
    button_in_top_left_room = SuikapelagoLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    button_item = items.SuikapelagoItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
    ...
    final_boss_room.add_event(
        "Final Boss Defeated", "Victory", location_type=SuikapelagoLocation, item_type=items.SuikapelagoItem
    )
